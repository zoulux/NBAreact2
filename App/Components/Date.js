    ...
    render() {
        return (
            <View style={{flexDirection: 'row'}}>
                        ...
                        {!this.state.loaded ? 'Checking number of games' :
                            (() => {
                                switch (this.state.numberOfGames === 0) {
                                    ...
                                    case false:
                                        switch (this.state.numberOfGames === 1) {
                                            case true:
                                                return 'There is 1 game today';
                                            case false:
                                                return 'There are ' + this.state.numberOfGames + ' games today';
                                        }
                                }
                            })()
                        }
                ...
                <View
                    style={{backgroundColor: 'blue', flex:0.25, justifyContent: 'center', alignItems: 'center'}}>
                    <DatePicker
                        style={{width: 100}}
